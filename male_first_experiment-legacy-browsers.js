...
function maleLoopLoopBegin(maleLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    maleLoop.forEach(function() {
      ...
      maleLoopLoopScheduler.add(mainTrialRoutineBegin(snapshot));
      maleLoopLoopScheduler.add(mainTrialRoutineEachFrame());
      maleLoopLoopScheduler.add(mainTrialRoutineEnd(snapshot));
...
function femaleLoopLoopBegin(femaleLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    femaleLoop.forEach(function() {
      ...
      femaleLoopLoopScheduler.add(mainTrial_2RoutineBegin(snapshot));
      femaleLoopLoopScheduler.add(mainTrial_2RoutineEachFrame());
      femaleLoopLoopScheduler.add(mainTrial_2RoutineEnd(snapshot));
  ...
  return async function () {
    ...
    fetch("https://pipe.jspsych.org/api/data/", {
      ...
      body: JSON.stringify({
        ...
        window.location.href = "https://app.prolific.com/submissions/complete?cc=C139REZF";
    }).catch(error => {
